-- lua/plugins/core/setup-sources.lua
-- local M = {}
--
...
M.mason_general_packages = {
  ...
  -- LSP servers (akan diinstall otomatis oleh mason-lspconfig)
  -- "lua_ls", -- sudah ada di mason_lsps
  -- "rust_analyzer", -- sudah ada di mason_lsps
